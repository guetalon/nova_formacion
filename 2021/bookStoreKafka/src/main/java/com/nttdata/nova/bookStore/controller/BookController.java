...
public class BookController {
	...
	public HttpEntity<BookDto> insertEditorial(@RequestBody BookDto book) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.CREATE, bookDto.getId()));
	...
	public HttpEntity<BookDto> updateEditorial(@RequestBody BookDto book) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.UPDATE, bookDto.getId()));
	...
	public HttpEntity<BookDto> getBookById(@PathVariable("id") Long id) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.FIND_ONE, bookDto.getId()));
	...
	public HttpEntity<String> deleteBook(@PathVariable("id") Long id) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.DELETE, id));
