...
import com.nttdate.nova.bookStore.producer.KafkaProducer;
...
public class BookController {
	...
	public HttpEntity<BookDto> insertBook(@RequestBody BookDto book) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.CREATE, bookDto!=null ? bookDto.getId() : null));
	...
	public HttpEntity<BookDto> updateBook(@RequestBody BookDto book) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.UPDATE, bookDto!=null ? bookDto.getId() : null));
	...
	public HttpEntity<BookDto> getBookById(@PathVariable("id") Long id) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.FIND_ONE, bookDto!=null ? bookDto.getId() : null));
	...
	public HttpEntity<String> deleteBook(@PathVariable("id") Long id) {
		...
		kafkaProducer.sendMessage(generateRegistryMessage(bookOperation.DELETE, id!=null ? id : null));
	...
	private String generateRegistryMessage(bookOperation operation, Long id) {
		String message = null;
